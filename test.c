...
*********************************************************************************************************
* In an infinite loop:
*       Recieve a character message
*       Display it on the terminal
*       & delay yourself for 100 ms
* Use this call to display the message on the terminal:
...
*/
/* @Feb 17th, 2010 By: Amr Ali Abdel-Naby */
/* Changed the name OSTaskStatHook to AppTaskStatHook */
void  AppTaskStatHook (void)
{
    char    s[80];
    INT8U   i;
    INT32U  total;
...
*/
/* @Feb 17th, 2010 By: Amr Ali Abdel-Naby */
/* Changed the name OSTaskSwHook to AppTaskSwHook */
void  AppTaskSwHook (void)
{
    INT32U           time;
...
/* @May 14th, 2011 By: Amr Ali Abdel-Naby */
void AppTaskReturnHook(OS_TCB *ptcb){
    ptcb = ptcb;
}
